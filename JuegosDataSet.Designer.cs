...
namespace Manipulacion_de_datos_LINQ {
    ...
    public partial class JuegosDataSet : global::System.Data.DataSet {
        ...
        public partial class datosDataTable : global::System.Data.TypedTableBase<datosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public datosRow AdddatosRow(string id, string contra, string pais, string nombre) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public datosRow FindByid(string id) {
        ...
        public partial class datosRow : global::System.Data.DataRow {
            ...
            public string id {
                get {
                    return ((string)(this[this.tabledatos.idColumn]));
                }
                set {
            ...
            public string contra {
                get {
                    return ((string)(this[this.tabledatos.contraColumn]));
                }
                set {
                    this[this.tabledatos.contraColumn] = value;
                }
            }
            ...
            public string pais {
                get {
                    return ((string)(this[this.tabledatos.paisColumn]));
                }
                set {
                    this[this.tabledatos.paisColumn] = value;
                }
            }
...
namespace Manipulacion_de_datos_LINQ.JuegosDataSetTableAdapters {
    ...
    public partial class datosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[datos] WHERE (([id] = @Original_id) AND ([contra] = @Original_" +
                "contra) AND ([pais] = @Original_pais) AND ([nombre] = @Original_nombre))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[datos] ([id], [contra], [pais], [nombre]) VALUES (@id, @contra" +
                ", @pais, @nombre);\r\nSELECT id, contra, pais, nombre FROM datos WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[datos] SET [id] = @id, [contra] = @contra, [pais] = @pais, [nombre] = @nombre WHERE (([id] = @Original_id) AND ([contra] = @Original_contra) AND ([pais] = @Original_pais) AND ([nombre] = @Original_nombre));
SELECT id, contra, pais, nombre FROM datos WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Manipulacion_de_datos_LINQ.Properties.Settings.Default.JuegosConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, contra, pais, nombre FROM dbo.datos";
        ...
        public virtual int Fill(JuegosDataSet.datosDataTable dataTable) {
        ...
        public virtual JuegosDataSet.datosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            JuegosDataSet.datosDataTable dataTable = new JuegosDataSet.datosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(JuegosDataSet.datosDataTable dataTable) {
        ...
        public virtual int Delete(string Original_id, string Original_contra, string Original_pais, string Original_nombre) {
            if ((Original_id == null)) {
            ...
            if ((Original_contra == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_contra));
            }
        ...
        public virtual int Insert(string id, string contra, string pais, string nombre) {
            if ((id == null)) {
        ...
        public virtual int Update(string id, string contra, string pais, string nombre, string Original_id, string Original_contra, string Original_pais, string Original_nombre) {
            if ((id == null)) {
                throw new global::System.ArgumentNullException("id");
            }
            else {
            ...
            if ((Original_contra == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_contra));
            }
            if ((Original_pais == null)) {
                throw new global::System.ArgumentNullException("Original_pais");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string contra, string pais, string nombre, string Original_id, string Original_contra, string Original_pais, string Original_nombre) {
            return this.Update(Original_id, contra, pais, nombre, Original_id, Original_contra, Original_pais, Original_nombre);
        }
    }
